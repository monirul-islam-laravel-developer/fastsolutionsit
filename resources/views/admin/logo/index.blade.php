                        ...
                        <div class="card box-shadow-0">
                            ...
                            <div class="card-body">
                                <form action="{{ isset($logo) ? route('logos.update', $logo->id) : route('logos.store') }}" method="POST" enctype="multipart/form-data" id="logoForm">
                                    ...
                                    <div class="form-group">
                                        <label for="desktopLogo" class="form-label">Fav Icon</label>
                                        <input class="form-control file-input" type="file" name="fav_icon" id="desktopLogo" onchange="previewImage(this, 'desktopPreview')">
                                        <img id="desktopPreview" src="{{ isset($logo) ? asset($logo->fav_icon) : '#' }}" alt="Desktop Logo Preview" class="img-fluid {{ isset($logo) ? '' : 'd-none' }}" height="80" width="120">
                                    </div>
