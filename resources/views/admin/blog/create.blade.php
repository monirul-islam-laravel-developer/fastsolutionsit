                ...
                <div class="row row-sm">
                    <div class="col-sm-12">
                        <div class="card box-shadow-0">
                            ...
                            <div class="card-body">
                                <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data" id="categoryForm">
                                    @csrf
                                    <div class="form-group">
                                        <label for="exampleInputEmail2">Title</label>
                                        <input type="text" name="title" required class="form-control" id="exampleInputEmail2" placeholder="Add Your Blog Title">
                                    </div>
