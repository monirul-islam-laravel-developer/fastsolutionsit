                    ...
                    <div class="col-lg-12">
                        <div class="breadcrumb-two-content">
                            ...
                            <ul class="breadcrumb-list flx-align gap-2 mb-2">
                                ...
                                <li class="breadcrumb-list__item font-14 text-body">
                                    <span class="breadcrumb-list__text">{{$theme->name}} </span>
                                    <span class="breadcrumb-list__icon font-10"><i class="fas fa-chevron-right"></i></span>
                                </li>
                                <li class="breadcrumb-list__item font-14 text-body">
                            ...
                            <h3 class="breadcrumb-two-content__title mb-3 text-capitalize">{{$theme->name}}</h3>
    ...
    <section class="arrival-product padding-y-120 section-bg position-relative z-index-1">
        ...
        <div class="container container-two">
            <div class="section-heading">
                <h3 class="section-heading__title">New Arrival Theme</h3>
            </div>
