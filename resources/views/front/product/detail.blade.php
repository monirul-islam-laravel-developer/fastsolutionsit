                        ...
                        <div class="tab-pane fade show active" id="pills-product-details" role="tabpanel" aria-labelledby="pills-product-details-tab" tabindex="0">
                            ...
                            <div class="product-details">
                                <div class="product-details__thumb">
                                    <img src="{{asset('/')}}front/assets/images/thumbs/product-details.png" alt="">
                                </div>
                                <div class="product-details__buttons flx-align justify-content-center gap-3">
                                    ...
                                    <a href="#" class="screenshot-btn btn btn-white pill px-sm-5" data-images='["{{asset('/')}}front/assets/images/thumbs/product-details.png", "{{asset('/')}}front/assets/images/thumbs/product-details.png"]'>Screenshot</a>
                                ...
                                <div class="product-details__item">
                                    ...
                                    <p class="product-details__desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident.</p>
                                </div>

                                <div class="more-item">
                                    <div class="flx-between mb-4">
                                        <h5 class="more-item__title">More Items</h5>
                                        <a href="profile.html" class="text-heading fw-500 hover-text-decoration-underline">View Author Profile</a>
                                    </div>
                                    <div class="more-item__content flx-align">
                                        <div class="more-item__item">
                                            <a href="all-product.html" class="link w-100 h-100 d-block">
                                                <img src="{{asset('/')}}front/assets/images/thumbs/more-item1.png" alt="">
                                            </a>
                                        </div>
                                        <div class="more-item__item">
                                            <a href="all-product.html" class="link w-100 h-100 d-block">
                                                <img src="{{asset('/')}}front/assets/images/thumbs/more-item2.png" alt="">
                                            </a>
                                        </div>
                                        <div class="more-item__item">
                                            <a href="all-product.html" class="link w-100 h-100 d-block">
                                                <img src="{{asset('/')}}front/assets/images/thumbs/more-item3.png" alt="">
                                            </a>
                                        </div>
                                        <div class="more-item__item">
                                            <a href="all-product.html" class="link w-100 h-100 d-block">
                                                <img src="{{asset('/')}}front/assets/images/thumbs/more-item4.png" alt="">
                                            </a>
                                        </div>
                                        <div class="more-item__item">
                                            <a href="all-product.html" class="link w-100 h-100 d-block">
                                                <img src="{{asset('/')}}front/assets/images/thumbs/more-item5.png" alt="">
                                            </a>
                                        </div>
                                        <div class="more-item__item">
                                            <a href="all-product.html" class="link w-100 h-100 d-block">
                                                <img src="{{asset('/')}}front/assets/images/thumbs/more-item6.png" alt="">
                                            </a>
                                        </div>
                                        <div class="more-item__item">
                                            <a href="all-product.html" class="link w-100 h-100 d-block">
                                                <img src="{{asset('/')}}front/assets/images/thumbs/more-item7.png" alt="">
                                            </a>
                                        </div>
                                        <div class="more-item__item">
                                            <a href="all-product.html" class="link w-100 h-100 d-block">
                                                <img src="{{asset('/')}}front/assets/images/thumbs/more-item8.png" alt="">
                                            </a>
                                        </div>
                                        <div class="more-item__item">
                                            <a href="all-product.html" class="link w-100 h-100 d-block">
                                                <img src="{{asset('/')}}front/assets/images/thumbs/more-item9.png" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="author-details">
                            <div class="d-flex align-items-center gap-2">
                                <div class="author-details__thumb flex-shrink-0">
                                    <img src="{{asset('/')}}front/assets/images/thumbs/author-details-img.png" alt="">
                                </div>
                    ...
                    <span class="star-rating__text text-body"> 5.0</span>
                            ...
                            <ul class="badge-list flx-align gap-2 mt-3">
                                <li class="badge-list__item" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Badge Info">
                                    <img src="{{asset('/')}}front/assets/images/thumbs/badge1.png" alt="">
                                </li>
                                <li class="badge-list__item" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Badge Info">
                                    <img src="{{asset('/')}}front/assets/images/thumbs/badge2.png" alt="">
                                </li>
                                <li class="badge-list__item" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Badge Info">
                                    <img src="{{asset('/')}}front/assets/images/thumbs/badge3.png" alt="">
                                </li>
                                <li class="badge-list__item" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Badge Info">
                                    <img src="{{asset('/')}}front/assets/images/thumbs/badge4.png" alt="">
                                </li>
                                <li class="badge-list__item" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Badge Info">
                                    <img src="{{asset('/')}}front/assets/images/thumbs/badge5.png" alt="">
                                </li>
                                <li class="badge-list__item" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Badge Info">
                                    <img src="{{asset('/')}}front/assets/images/thumbs/badge6.png" alt="">
                                </li>
                                <li class="badge-list__item" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Badge Info">
                                    <img src="{{asset('/')}}front/assets/images/thumbs/badge7.png" alt="">
                                </li>
                                <li class="badge-list__item" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Badge Info">
                                    <img src="{{asset('/')}}front/assets/images/thumbs/badge8.png" alt="">
                                </li>
                            </ul>
