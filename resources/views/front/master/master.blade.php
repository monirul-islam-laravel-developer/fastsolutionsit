...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{$logo->fav_icon}}">
...
<div class="mobile-menu d-lg-none d-block">
    ...
    <div class="mobile-menu__inner">
        <a href="{{route('home')}}" class="mobile-menu__logo">
            <img src="{{asset('/')}}front/assets/images/logo/logo.png" alt="Logo" class="white-version">
            <img src="{{asset('/')}}front/assets/images/logo/white-logo-two.png" alt="Logo" class="dark-version">
        </a>
