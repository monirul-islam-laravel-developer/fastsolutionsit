...
" />
    <meta name="title" content="{{$themess->sub_category->name}}"/>
    <meta name="description" content="{{\Illuminate\Support\Str::limit(strip_tags($themess->sub_category->description), 300)}}">

    <meta property="article:type" content="website">
    <meta property="article:title" content="{{$themess->sub_category->name}}">
    <meta property="article:url" content="{{request()->url()}}">
    <meta property="article:description" content="{{\Illuminate\Support\Str::limit(strip_tags($themess->sub_category->description), 300)}}">
    <meta property="article:image" content="{{asset($themess->sub_category->image)}}">
    <meta property="article:published_time" content="{{$themess->sub_category->created_at->format('Y-m-d h:i:s A, F Y, l')}}" />
    <meta property="article:modified_time" content="{{$themess->sub_category->updated_at->format('Y-m-d h:i:s A, F Y, l')}}" />


    <meta property="og:url" content="{{ request()->url() }}" />
    <meta property="og:type" content="article" />
    <meta property="og:site_name" content="Arman - PHP Laravel Developer" />
    <meta property="og:title" content="{{$themess->sub_category->name}}" />
    <meta property="og:description" content="{{\Illuminate\Support\Str::limit(strip_tags($themess->sub_category->description), 300)}}" />
    <meta property="og:image" content="{{ asset($themess->sub_category->image) }}" />
    <meta property="og:image:width" content="1200" />
    <meta property="og:image:height" content="630" />
    <meta property="og:image:secure_url" content="{{ asset($themess->sub_category->image) }}" />
    <meta property="og:image:alt" content="{{$themess->sub_category->name}}" />
    <link rel="image_src" href="{{ asset($themess->sub_category->image) }}">

    <meta name="twitter:card" content="summary_large_image">
    <meta property="twitter:domain" content="armanalibd.com">
    <meta property="twitter:url" content="{{ request()->url() }}">
    <meta name="twitter:title" content="{{$themess->sub_category->name}} | {{env('APP_NAME')}}">
    <meta name="twitter:hashtags" content="Laravel Developer, PHP Developer, HTML, CSS, Bootstrap, Vue.js Developer,">
    <meta name="twitter:description" content="{{\Illuminate\Support\Str::limit(strip_tags($themess->sub_category->description), 300)}}">
    <meta name="twitter:image" content="{{ asset($themess->sub_category->image) }}">
