...
" />
    ...
    <meta name="description" content="{{\Illuminate\Support\Str::limit(strip_tags($cat_id->description), 300)}}">
    ...
    <meta property="article:description" content="{{\Illuminate\Support\Str::limit(strip_tags($cat_id->description), 300)}}">
    ...
    <meta property="og:description" content="{{\Illuminate\Support\Str::limit(strip_tags($cat_id->description), 300)}}" />
    ...
    <meta name="twitter:description" content="{{\Illuminate\Support\Str::limit(strip_tags($cat_id->description), 300)}}">
